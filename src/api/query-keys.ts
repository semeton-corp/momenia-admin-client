export const queryKeys = {
  ...
  admins: {
    ...
    detail: (id: string | number) =>
      [...queryKeys.admins.all, "detail", id] as const,
  },
  cmsUsers: {
    all: ["cms-users"] as const,
    lists: () => [...queryKeys.cmsUsers.all, "list"] as const,
    list: (params?: unknown) =>
      [...queryKeys.cmsUsers.lists(), params] as const,
    detail: (id: string, params?: unknown) =>
      [...queryKeys.cmsUsers.all, "detail", id, params] as const,
  },
  cmsTransactions: {
    all: ["cms-transactions"] as const,
    lists: () => [...queryKeys.cmsTransactions.all, "list"] as const,
    list: (params?: unknown) =>
      [...queryKeys.cmsTransactions.lists(), params] as const,
    detail: (id: string) =>
      [...queryKeys.cmsTransactions.all, "detail", id] as const,
  },
  cmsDashboard: {
    all: ["cms-dashboard"] as const,
    overview: (period: string) =>
      [...queryKeys.cmsDashboard.all, "overview", period] as const,
    topSellingTemplates: () =>
  ...
  invitationTemplates: {
    ...
    lists: (params?: unknown) =>
      [...queryKeys.invitationTemplates.all, "list", params] as const,
    detail: (id: string) =>
      [...queryKeys.invitationTemplates.all, "detail", id] as const,
  },
  invitationTemplateCategories: {
    all: ["invitation-template-categories"] as const,
    lists: () =>
      [...queryKeys.invitationTemplateCategories.all, "list"] as const,
  },
  ...
  invitationTemplateDurations: {
    ...
    lists: () =>
      [...queryKeys.invitationTemplateDurations.all, "list"] as const,
    detail: (id: string) =>
      [...queryKeys.invitationTemplateDurations.all, "detail", id] as const,
  },
  contentInvitationTemplates: {
    all: ["content-invitation-templates"] as const,
    lists: (parentId: number | null) =>
